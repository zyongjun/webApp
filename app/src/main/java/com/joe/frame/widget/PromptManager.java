...
import com.joe.frame.WebApplication;
...
public class PromptManager implements View.OnClickListener {
    ...
    private void initDialog(){
        ...
        dialogWindow.setBackgroundDrawableResource(R.color.color_transparent);
        WindowManager.LayoutParams lp = dialogWindow.getAttributes();
        lp.width = WebApplication.getInstance().getDisplayMetrics().widthPixels*3/4;
    }
        ...
        if (dialog != null && callback != null) {
            ...
            if (!TextUtils.isEmpty(title)) {
                ...
                if(TextUtils.isEmpty(msg)){
                    int padding = mContext.getResources().getDimensionPixelSize(R.dimen.single_choice_dialog_padding_top);
